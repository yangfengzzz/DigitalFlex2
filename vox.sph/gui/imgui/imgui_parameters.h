...
public:
    ...
    static void createRealParameter(imguiParameters::imguiParameter* param,
                                    ImGuiInputTextFlags flags,
                                    const std::string& helpText);
    static void createBoolParameter(imguiParameters::imguiParameter* param,
                                    ImGuiInputTextFlags flags,
                                    const std::string& helpText);
    static void createStringParameter(imguiParameters::imguiParameter* param,
                                      ImGuiInputTextFlags flags,
                                      const std::string& helpText);
    static void createVec3rParameter(imguiParameters::imguiParameter* param,
                                     ImGuiInputTextFlags flags,
                                     const std::string& helpText);
    static void createVec3fParameter(imguiParameters::imguiParameter* param,
                                     ImGuiInputTextFlags flags,
                                     const std::string& helpText);
    static bool createEnumParameter(imguiParameters::imguiParameter* param,
                                    ImGuiInputTextFlags flags,
                                    const std::string& helpText);
    template <typename T>
    static void createNumericParameter(imguiParameters::imguiParameter* param,
                                       ImGuiInputTextFlags flags,
                                       const std::string& helpText);
    static void createFunctionParameter(imguiParameters::imguiParameter* param,
                                        ImGuiInputTextFlags flags,
                                        const std::string& helpText);
...
protected:
    ...
    static std::vector<std::pair<std::string, std::vector<std::pair<std::string, std::vector<imguiParameter*>>>>>
            m_imguiParams;

    static void createSubgroupParameters(
            const std::vector<std::pair<std::string, std::vector<imguiParameter*>>>& params);
};

template <typename T>
inline void imguiParameters::createNumericParameter(imguiParameters::imguiParameter* param,
                                                    ImGuiInputTextFlags flags,
                                                    const std::string& helpText) {

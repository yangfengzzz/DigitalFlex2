...
public:
    ...
    [[nodiscard]] FORCE_INLINE const Real &getLambda(const unsigned int fluidIndex, const unsigned int i) const {
    ...
    [[nodiscard]] FORCE_INLINE const Vector3r &getDeltaX(const unsigned int fluidIndex, const unsigned int i) const {
        return m_deltaX[fluidIndex][i];
    }
    ...
    [[nodiscard]] FORCE_INLINE const Vector3r &getLastPosition(const unsigned int fluidIndex,
    ...
    [[nodiscard]] FORCE_INLINE const Vector3r &getOldPosition(const unsigned int fluidIndex,
                                                              const unsigned int i) const {
        return m_oldX[fluidIndex][i];
    }

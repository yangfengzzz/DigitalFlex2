...
public:
    ...
    static Real W(const Vector3r &r) { return W(r.norm()); }
...
public:
    static Real W(const Real r) {
        ...
        const Real q = r / m_radius;
        if (q <= 1.0)
            res = m_k * pow(static_cast<Real>(1.0) - q, static_cast<Real>(4.0)) *
                  (static_cast<Real>(4.0) * q + static_cast<Real>(1.0));
        return res;
    }
...
public:
    ...
    static Real W(const Real r) {
        ...
        if (r2 <= radius2) {
            if (r > 0.5 * m_radius)
                res = m_k * pow(-static_cast<Real>(4.0) * r2 / m_radius + static_cast<Real>(6.0) * r -
                                        static_cast<Real>(2.0) * m_radius,
    ...
    static Real W(const Vector3r &r) {
        ...
        if (r2 <= radius2) {
            ...
            if (rl > 0.5 * m_radius)
                res = m_k * pow(-static_cast<Real>(4.0) * r2 / m_radius + static_cast<Real>(6.0) * rl -
                                        static_cast<Real>(2.0) * m_radius,
                                static_cast<Real>(0.25));
        }
        return res;

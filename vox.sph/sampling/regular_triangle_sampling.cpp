...
RegularTriangleSampling::RegularTriangleSampling() = default;

void RegularTriangleSampling::sampleMesh(const unsigned int numVertices,
...
void RegularTriangleSampling::appendVertexSamples(const unsigned int numVertices,
                                                  const Vector3r* vertices,
                                                  std::vector<Vector3r>& samples) {
    samples.insert(samples.end(), vertices, vertices + numVertices);
}

void RegularTriangleSampling::appendEdgeSamples(const Real d,
                                                const Vector3r* vertices,
...
void RegularTriangleSampling::appendFaceSamples(const Real d,
                                                const Vector3r* vertices,
...
std::vector<RegularTriangleSampling::Vector2ui> RegularTriangleSampling::uniqueEdges(unsigned int numFaces,
                                                                                     const unsigned int* faces) {
    ...
    const auto less = [](const Vector2ui& a, const Vector2ui& b) -> bool {

...
public:
    ...
    [[nodiscard]] FORCE_INLINE Real getAii(const unsigned int fluidIndex, const unsigned int i) const {
        return m_aii[fluidIndex][i];
    }

    FORCE_INLINE Real &getAii(const unsigned int fluidIndex, const unsigned int i) { return m_aii[fluidIndex][i]; }

    FORCE_INLINE void setAii(const unsigned int fluidIndex, const unsigned int i, const Real aii) {
        m_aii[fluidIndex][i] = aii;
    }

    FORCE_INLINE Vector3r &getDii(const unsigned int fluidIndex, const unsigned int i) { return m_dii[fluidIndex][i]; }

    [[nodiscard]] FORCE_INLINE const Vector3r &getDii(const unsigned int fluidIndex, const unsigned int i) const {
    ...
    [[nodiscard]] FORCE_INLINE const Vector3r &getDij_pj(const unsigned int fluidIndex, const unsigned int i) const {
        return m_dij_pj[fluidIndex][i];
    }
    ...
    [[nodiscard]] FORCE_INLINE Real getLastPressure(const unsigned int fluidIndex, const unsigned int i) const {

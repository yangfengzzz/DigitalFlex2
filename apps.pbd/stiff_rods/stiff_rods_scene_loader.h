...
namespace vox {
class StiffRodsSceneLoader : public utility::SceneLoader {
public:
    ~StiffRodsSceneLoader() override = default;
...
protected:
    ...
    void parseCompactTreeModels(const nlohmann::json &j,
                                const std::string &key,
                                SceneData &sceneData,
                                const std::string &basePath);
    void parseSkinningMeshes(const nlohmann::json &j,
                             const std::string &key,
                             SceneData &sceneData,
                             const std::string &basePath);

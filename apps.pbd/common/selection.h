...
public:
    ...
    static void selectRect(const Eigen::Vector2i &start,
                           const Eigen::Vector2i &end,
                           const PositionIteratorType &posBegin,
                           const PositionIteratorType &posEnd,
        ...
        auto left = (float)ileft;
        auto right = (float)iright;
        auto top = (float)itop;
        auto bottom = (float)ibottom;
    ...
    template <typename PositionIteratorType>
    static void processSelectionHits(SelectionPlane *planes,
                                     const PositionIteratorType &posBegin,
                                     const PositionIteratorType &posEnd,
                                     std::vector<unsigned int> &hits) {

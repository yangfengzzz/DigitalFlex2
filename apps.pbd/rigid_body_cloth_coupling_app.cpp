...
void createRigidBodyModel() {
    ...
    utility::IndexedFaceMesh mesh_static;
    ...
    //////////////////////////////////////////////////////////////////////////
    rb[0] = new RigidBody();
    rb[0]->initBody(0.0, Vector3r(-5.0, 0.0, -5.0), computeInertiaTensorBox(1.0, 0.5, 0.5, 0.5),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd_static, mesh_static);

    // dynamic body
    rb[1] = new RigidBody();
    rb[1]->initBody(1.0, Vector3r(-5.0, 1.0, -5.0), computeInertiaTensorBox(1.0, width, height, depth),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);

    // dynamic body
    rb[2] = new RigidBody();
    rb[2]->initBody(1.0, Vector3r(-5.0, 3.0, -5.0), computeInertiaTensorBox(1.0, width, height, depth),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);
    ...
    //////////////////////////////////////////////////////////////////////////
    rb[3] = new RigidBody();
    rb[3]->initBody(0.0, Vector3r(5.0, 0.0, -5.0), computeInertiaTensorBox(1.0, 0.5, 0.5, 0.5),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd_static, mesh_static);

    // dynamic body
    rb[4] = new RigidBody();
    rb[4]->initBody(1.0, Vector3r(5.0, 1.0, -5.0), computeInertiaTensorBox(1.0, width, height, depth),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);

    // dynamic body
    rb[5] = new RigidBody();
    rb[5]->initBody(1.0, Vector3r(5.0, 3.0, -5.0), computeInertiaTensorBox(1.0, width, height, depth),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);
    ...
    //////////////////////////////////////////////////////////////////////////
    rb[6] = new RigidBody();
    rb[6]->initBody(0.0, Vector3r(5.0, 0.0, 5.0), computeInertiaTensorBox(1.0, 0.5, 0.5, 0.5),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd_static, mesh_static);

    // dynamic body
    rb[7] = new RigidBody();
    rb[7]->initBody(1.0, Vector3r(5.0, 1.0, 5.0), computeInertiaTensorBox(1.0, width, height, depth),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);

    // dynamic body
    rb[8] = new RigidBody();
    rb[8]->initBody(1.0, Vector3r(5.0, 3.0, 5.0), computeInertiaTensorBox(1.0, width, height, depth),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);
    ...
    //////////////////////////////////////////////////////////////////////////
    rb[9] = new RigidBody();
    rb[9]->initBody(0.0, Vector3r(-5.0, 0.0, 5.0), computeInertiaTensorBox(1.0, 0.5, 0.5, 0.5),
                    Quaternionr(1.0, 0.0, 0.0, 0.0), vd_static, mesh_static);

    // dynamic body
    rb[10] = new RigidBody();
    rb[10]->initBody(1.0, Vector3r(-5.0, 1.0, 5.0), computeInertiaTensorBox(1.0, width, height, depth),
                     Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);

    // dynamic body
    rb[11] = new RigidBody();
    rb[11]->initBody(1.0, Vector3r(-5.0, 3.0, 5.0), computeInertiaTensorBox(1.0, width, height, depth),
                     Quaternionr(1.0, 0.0, 0.0, 0.0), vd, mesh);
...
void createClothMesh() {
    ...
    model->addRegularTriangleModel(nCols, nRows, Vector3r(-5, 4, -5),
                                   AngleAxisr(M_PI * 0.5, Vector3r(1, 0, 0)).matrix(),
                                   Vector2r(clothWidth, clothHeight));

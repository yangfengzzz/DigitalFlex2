 ...
 * parameter type */
template <typename T> class NumericParameter : public Parameter<T> {
protected:
  T m_minValue;
  T m_maxValue;

public:
  NumericParameter(const std::string &name, const std::string &label,
                   T *valuePtr)
  ...
  template <typename TN> void setType(TN v) {}

  void setType(char v) {
    ParameterBase::m_type = ParameterBase::DataTypes::INT8;
  }
  void setType(short v) {
    ParameterBase::m_type = ParameterBase::DataTypes::INT16;
  }
  void setType(int v) {
    ParameterBase::m_type = ParameterBase::DataTypes::INT32;
  }
  void setType(unsigned char v) {
    ParameterBase::m_type = ParameterBase::DataTypes::UINT8;
  }
  void setType(unsigned short v) {
    ParameterBase::m_type = ParameterBase::DataTypes::UINT16;
  }
  void setType(unsigned int v) {
    ParameterBase::m_type = ParameterBase::DataTypes::UINT32;
  }
  void setType(float v) {
    ParameterBase::m_type = ParameterBase::DataTypes::FLOAT;
  }
  void setType(double v) {
    ParameterBase::m_type = ParameterBase::DataTypes::DOUBLE;
  }
};

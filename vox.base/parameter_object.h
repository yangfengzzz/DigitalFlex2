...
public:
    ...
    int createBoolParameter(const std::string &name,
        ...
        m_parameters.push_back(std::make_unique<Parameter<bool>>(name, label, ParameterBase::BOOL, getValue, setValue));
        return static_cast<int>(m_parameters.size() - 1);
    }
    ...
    int createEnumParameter(const std::string &name,
        ...
        m_parameters.push_back(std::make_unique<EnumParameter>(name, label, getValue, setValue));
        return static_cast<int>(m_parameters.size() - 1);
    }
    ...
    int createStringParameter(const std::string &name,
        ...
        m_parameters.push_back(
                std::make_unique<Parameter<std::string>>(name, label, ParameterBase::STRING, getValue, setValue));
        return static_cast<int>(m_parameters.size() - 1);
    }

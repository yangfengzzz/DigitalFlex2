...
public:
    ...
    inline Self operator+(Self const &rhs) { return Self(m_index + rhs.m_index, m_mesh); }
...
public:
    ...
    inline Self operator+(Self const &rhs) const { return Self(m_index + rhs.m_index, m_mesh); }
    inline difference_type operator-(Self const &rhs) const { return m_index - rhs.m_index; }
    inline Self operator-(int const &rhs) const { return Self(m_index - rhs, m_mesh); }

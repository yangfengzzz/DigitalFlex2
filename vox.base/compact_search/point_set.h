...
public:
     ...
     */
    [[nodiscard]] unsigned int neighbor(unsigned int point_set, unsigned int i, unsigned int k) const {
     ...
     */
    [[nodiscard]] const std::vector<unsigned int> &neighbor_list(unsigned int point_set, unsigned int i) const {
...
private:
    ...
    void resize(Real const *x, std::size_t n) {
        m_x = x;
        m_n = n;
        m_keys.resize(n, {std::numeric_limits<int>::lowest(), std::numeric_limits<int>::lowest(),
                          std::numeric_limits<int>::lowest()});
        m_old_keys.resize(n, {std::numeric_limits<int>::lowest(), std::numeric_limits<int>::lowest(),
                              std::numeric_limits<int>::lowest()});

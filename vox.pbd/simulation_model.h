...
#include "vox.pbd/triangle_model.h"

namespace vox {
class Constraint;

class simulation_model : public ParameterObject {
public:
    simulation_model();
    simulation_model(const simulation_model &) = delete;
    simulation_model &operator=(const simulation_model &) = delete;

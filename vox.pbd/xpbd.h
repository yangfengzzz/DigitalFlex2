...
public:
     ...
     * particles using XPBD:\n\n \f$C(\mathbf{p}_0, \mathbf{p}_1) = \|
     * \mathbf{p}_0 - \mathbf{p}_1\| - l_0 = 0\f$\n\n More information can be
     * found in the following papers: \cite Mueller07, \cite BMOT2013, \cite
     * BMOTM2014, \cite BMM2015, \cite MMC16
     *
     ...
     * using XPBD. This constraint can be used for almost inextensible surface

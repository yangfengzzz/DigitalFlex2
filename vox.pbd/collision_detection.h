...
public:
    ...
    virtual void collisionDetection(simulation_model &model) = 0;
    ...
    void updateAABBs(simulation_model &model);
    void updateAABB(simulation_model &model, CollisionDetection::CollisionObject *co);
};
}  // namespace vox
...
public:
    ...
    void setPoints(const std::vector<Vector3r> &p) {
        ...
        // generate random permutation of the points and permute the points by
        ...
        m_x = S.m_x;
        m_r = S.m_r + static_cast<Real>(epsilon);  // add epsilon to make sure that all
                                                   // non-pertubated points are inside the sphere
    }
...
private:
    /**
     * \brief		constructs the smallest enclosing sphere for n points with
     * the points q1, q2, and q3 on the surface of the sphere
     *
    ...
    /**
     * \brief		constructs the smallest enclosing sphere for n points with
     * the points q1 and q2 on the surface of the sphere
     *
     * \param n		number of points
     * \param p		vertices of the points
     * \param q1	3d coordinates of a point on the surface
    ...
    /**
     * \brief		constructs the smallest enclosing sphere for n points with
     * the point q1 on the surface of the sphere
     *
     * \param n		number of points
     * \param p		vertices of the points
     * \param q1	3d coordinates of a point on the surface

...
public:
    ...
    virtual bool initConstraintBeforeProjection(simulation_model &model) { return true; };
    virtual bool updateConstraint(simulation_model &model) { return true; };
    virtual bool solvePositionConstraint(simulation_model &model, const unsigned int iter) { return true; };
    virtual bool solveVelocityConstraint(simulation_model &model, const unsigned int iter) { return true; };
};
...
public:
    ...
    bool initConstraint(simulation_model &model,
                        const unsigned int rbIndex1,
                        const unsigned int rbIndex2,
                        const Vector3r &pos);
    virtual bool updateConstraint(simulation_model &model);
    virtual bool solvePositionConstraint(simulation_model &model, const unsigned int iter);
};
...
public:
    ...
    virtual bool updateConstraint(simulation_model &model);
    virtual bool solvePositionConstraint(simulation_model &model, const unsigned int iter);
    virtual bool solveVelocityConstraint(simulation_model &model, const unsigned int iter);
};
...
public:
    ...
    bool initConstraint(simulation_model &model, const unsigned int rbIndex, const unsigned int particleIndex);
    virtual bool updateConstraint(simulation_model &model);
    virtual bool solvePositionConstraint(simulation_model &model, const unsigned int iter);
};
...
public:
    ...
    virtual bool initConstraint(simulation_model &model,
...
public:
    ...
    bool initConstraint(simulation_model &model,
                        ...
                        Real youngsModulus,
                        Real torsionModulus);
    virtual bool initConstraintBeforeProjection(simulation_model &model);
    virtual bool updateConstraint(simulation_model &model);
    virtual bool solvePositionConstraint(simulation_model &model, const unsigned int iter);
};
...
class DirectPositionBasedSolverForStiffRodsConstraint : public Constraint {
    ...
    public:
        RodSegmentImpl(simulation_model &model, unsigned int idx) : m_model(model), m_segmentIdx(idx){};
...
protected:
    ...
    /** list to process nodes with increasing row index in the system matrix H
     * (from the leaves to the root) */
    std::list<Node *> *forward;
    /** list to process nodes starting with the highest row index to row index
     * zero in the matrix H (from the root to the leaves) */

...
public:
    ...
    bool initConstraint(SimulationModel &model, unsigned int rbIndex1, unsigned int rbIndex2, const Vector3r &pos);
...
public:
    ...
    bool initConstraint(SimulationModel &model, unsigned int rbIndex1, unsigned int rbIndex2, const Vector3r &axis);
    bool updateConstraint(SimulationModel &model) override;
    bool solvePositionConstraint(SimulationModel &model, unsigned int iter) override;
};
...
public:
    ...
    bool initConstraint(
            SimulationModel &model, unsigned int rbIndex1, unsigned int rbIndex2, const Vector3r &axis, Real stiffness);
    bool updateConstraint(SimulationModel &model) override;
    bool solvePositionConstraint(SimulationModel &model, unsigned int iter) override;
};

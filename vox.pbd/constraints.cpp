...
//////////////////////////////////////////////////////////////////////////
bool XPBD_FEMTetConstraint::initConstraint(SimulationModel &model,
...
bool XPBD_FEMTetConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter) {
    ...
    Vector3r corr1, corr2, corr3, corr4;
    const bool res = XPBD::solve_FEMTetraConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_volume,
                                                    m_invRestMat, m_stiffness, m_poissonRatio, handleInversion, dt,
                                                    m_lambda, corr1, corr2, corr3, corr4);
...
bool DirectPositionBasedSolverForStiffRodsConstraint::initConstraint(
    ...
    // initialize m_bodies for constraint colouring algorithm of multi threading
    // implementation
    ...
    // create RodSegment instances and map simulation model body indices to
    // RodSegment indices

...
void TimeStep::clearAccelerations(simulation_model &model) {
    //////////////////////////////////////////////////////////////////////////
    // rigid body model
    //////////////////////////////////////////////////////////////////////////
...
void TimeStep::setCollisionDetection(simulation_model &model, CollisionDetection *cd) {
...
void TimeStep::contactCallbackFunction(const unsigned int contactType,
                                       ...
                                       void *userData) {
    simulation_model *model = (simulation_model *)userData;

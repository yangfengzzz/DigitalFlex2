...
public:
    enum CollisionObjectTypes { No_Collision_Object = 0, Sphere, Box, Cylinder, Torus, SDF, HollowSphere, HollowBox };
    ...
    struct SceneData {
        enum TriangleModelSimulationMethodTypes {
            No_Simulation_Method = 0,
    ...
    static bool readVector(const nlohmann::json &j,
                           const std::string &key,

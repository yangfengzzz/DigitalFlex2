...
#include "vox.sph/position_based_dynamics_wrapper/pbd_simulator_gui_imgui.h"

#include "vox.sph/file_system.h"
#include "vox.sph/gui/imgui/imgui_parameters.h"
#include "vox.sph/simulation.h"
#include "vox.sph/time_step_controller.h"
...
PBD_Simulator_GUI_imgui::~PBD_Simulator_GUI_imgui(void) { delete m_shader; }
...
Shader *PBD_Simulator_GUI_imgui::createShader(const std::string &vertexShader,
...
void PBD_Simulator_GUI_imgui::initSimulationParameterGUI() {
    ...
    eparam->getFct = [this]() -> int {
        return m_pbdWrapper->getTimeStepController().getValue<int>(PBD::TimeStepController::VELOCITY_UPDATE_METHOD);
    };
    eparam->setFct = [this](int v) {
        m_pbdWrapper->getTimeStepController().setValue(PBD::TimeStepController::VELOCITY_UPDATE_METHOD, v);
    };
    ...
    uparam->minValue = 1;
    uparam->getFct = [this]() -> unsigned int {
        return m_pbdWrapper->getTimeStepController().getValue<int>(PBD::TimeStepController::MAX_ITERATIONS);
    };
    uparam->setFct = [this](unsigned int v) {
        m_pbdWrapper->getTimeStepController().setValue(PBD::TimeStepController::MAX_ITERATIONS, v);
    };
    ...
    uparam->minValue = 1;
    uparam->getFct = [this]() -> unsigned int {
        return m_pbdWrapper->getTimeStepController().getValue<int>(PBD::TimeStepController::MAX_ITERATIONS_V);
    };
    uparam->setFct = [this](unsigned int v) {
        m_pbdWrapper->getTimeStepController().setValue(PBD::TimeStepController::MAX_ITERATIONS_V, v);
    };
    imguiParameters::addParam("PBD", "Simulation", uparam);
    ...
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getContactStiffnessParticleRigidBody();
    };
    ...
    eparam->setFct = [this](int v) {
        m_pbdWrapper->setClothSimulationMethod(v);
        m_pbdWrapper->reset();
    };
    imguiParameters::addParam("PBD", "Simulation", eparam);
    ...
    eparam->setFct = [this](int v) {
        m_pbdWrapper->setSolidSimulationMethod(v);
        m_pbdWrapper->reset();
    };
    imguiParameters::addParam("PBD", "Simulation", eparam);
    ...
    eparam->setFct = [this](int v) {
        m_pbdWrapper->setBendingMethod(v);
        m_pbdWrapper->reset();
    };
    imguiParameters::addParam("PBD", "Simulation", eparam);
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_BENDING_STIFFNESS);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_BENDING_STIFFNESS, v);
    };
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_STIFFNESS);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_STIFFNESS, v);
    };
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_STIFFNESS_XX);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_STIFFNESS_XX, v);
    };
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_STIFFNESS_YY);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_STIFFNESS_YY, v);
    };
    imguiParameters::addParam("PBD", "FEM based PBD", rparam);
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_STIFFNESS_XY);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_STIFFNESS_XY, v);
    };
    imguiParameters::addParam("PBD", "FEM based PBD", rparam);
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_POISSON_RATIO_XY);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_POISSON_RATIO_XY, v);
    };
    imguiParameters::addParam("PBD", "FEM based PBD", rparam);
    ...
    rparam->minValue = 0.0;
    rparam->getFct = [this]() -> Real {
        return m_pbdWrapper->getSimulationModel().getValue<Real>(PBD::SimulationModel::CLOTH_POISSON_RATIO_YX);
    };
    rparam->setFct = [this](Real v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_POISSON_RATIO_YX, v);
    };
    imguiParameters::addParam("PBD", "FEM based PBD", rparam);
    ...
    bparam->getFct = [this]() -> bool {
        return m_pbdWrapper->getSimulationModel().getValue<bool>(PBD::SimulationModel::CLOTH_NORMALIZE_STRETCH);
    };
    bparam->setFct = [this](bool v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_NORMALIZE_STRETCH, v);
    };
    ...
    bparam->getFct = [this]() -> bool {
        return m_pbdWrapper->getSimulationModel().getValue<bool>(PBD::SimulationModel::CLOTH_NORMALIZE_SHEAR);
    };
    bparam->setFct = [this](bool v) {
        m_pbdWrapper->getSimulationModel().setValue(PBD::SimulationModel::CLOTH_NORMALIZE_SHEAR, v);
    };
    imguiParameters::addParam("PBD", "Strain based dynamics", bparam);
}
